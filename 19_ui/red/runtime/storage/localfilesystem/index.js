            ...
            try {
                ...
                try {
                    ...
                    if (process.env.HOMEPATH) {
                        fs.statSync(fspath.join(process.env.HOMEPATH,".node-red-ui",".config.json"));
                        settings.userDir = fspath.join(process.env.HOMEPATH,".node-red-ui");
                    }
                } catch(err) {
                }
                if (!settings.userDir) {
                    settings.userDir = fspath.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH || process.env.NODE_RED_HOME,".node-red-ui");
